var $=Object.defineProperty,D=Object.defineProperties;var L=Object.getOwnPropertyDescriptors;var w=Object.getOwnPropertySymbols;var S=Object.prototype.hasOwnProperty,q=Object.prototype.propertyIsEnumerable;var g=(d,t,e)=>t in d?$(d,t,{enumerable:!0,configurable:!0,writable:!0,value:e}):d[t]=e,p=(d,t)=>{for(var e in t||(t={}))S.call(t,e)&&g(d,e,t[e]);if(w)for(var e of w(t))q.call(t,e)&&g(d,e,t[e]);return d},v=(d,t)=>D(d,L(t));var b=(d,t,e)=>(g(d,typeof t!="symbol"?t+"":t,e),e);import{i as E,a as k,f as C,b as I}from"./vendor.71e5df89.js";const x=function(){const t=document.createElement("link").relList;if(t&&t.supports&&t.supports("modulepreload"))return;for(const i of document.querySelectorAll('link[rel="modulepreload"]'))o(i);new MutationObserver(i=>{for(const s of i)if(s.type==="childList")for(const a of s.addedNodes)a.tagName==="LINK"&&a.rel==="modulepreload"&&o(a)}).observe(document,{childList:!0,subtree:!0});function e(i){const s={};return i.integrity&&(s.integrity=i.integrity),i.referrerpolicy&&(s.referrerPolicy=i.referrerpolicy),i.crossorigin==="use-credentials"?s.credentials="include":i.crossorigin==="anonymous"?s.credentials="omit":s.credentials="same-origin",s}function o(i){if(i.ep)return;i.ep=!0;const s=e(i);fetch(i.href,s)}};x();const u=class{constructor(){this.projects=[]}get todayProjects(){return[...this.projects].map(t=>v(p({},t),{todos:t.todos.filter(({dueDate:e})=>E(e))})).filter(t=>t.todos.length)}get thisWeekProjects(){return[...this.projects].map(t=>v(p({},t),{todos:t.todos.filter(({dueDate:e})=>k(e,{weekStartsOn:1}))})).filter(t=>t.todos.length)}init(){const t=localStorage.getItem(u.odinTodoLocalStorageLabel);t?(this.projects=JSON.parse(t),this.updateProjectsTimeData()):this.projects=u.demoData}updateProjectsTimeData(){this.projects.forEach(t=>{t.dateCreated=new Date(t.dateCreated),(t==null?void 0:t.todos.length)&&t.todos.forEach(e=>{e.dueDate=new Date(e.dueDate)})}),console.log(this.projects)}setData(){const t=JSON.stringify(this.projects);localStorage.setItem(u.odinTodoLocalStorageLabel,t)}addProject(t){this.projects.push(t),this.setData()}updateProject(t,e){this.projects[t]=v(p({},this.projects[t]),{title:e.title,description:e.description}),this.setData()}deleteProject(t){this.projects.splice(t,1),this.setData()}markTodoAsDone(t,e,o){this.projects[t].todos[e].completed=o,this.setData()}addTodo(t,e){this.projects[t].todos.push(e),this.setData()}updateTodo(t,e,o){this.projects[t].todos[e]=p(p({},this.projects[t].todos[e]),o),this.setData()}deleteTodo(t,e){this.projects[t].todos.splice(e,1),this.setData()}hasProject(t){return this.projects.some(e=>e.title===t)}getProjectIndexByTitle(t){return this.projects.findIndex(e=>e.title===t)}};let j=u;b(j,"demoData",[{title:"Project demo",description:"This project serves as a demo, when no data is available on localStorage",dateCreated:new Date,todos:[{completed:!1,title:"My first thing todo",dueDate:new Date,priority:"high"},{completed:!0,title:"This task is done!",dueDate:new Date,priority:"medium"},{completed:!0,title:"This task is also done!",dueDate:new Date,priority:"low"}]}]),b(j,"odinTodoLocalStorageLabel","odin-todo");var H=new j;class N{constructor(){this.dom={app:document.querySelector("#app")}}init(){this.dom.nav=document.querySelector("nav"),this.dom.pageContainer=document.querySelector("article")}humanRedableTime(t){return C(t,new Date,{addSuffix:!0})}formatToDateInput(t){const[e,o,i]=t.toLocaleDateString().split("/");return`${i}-${e.padStart(2,"0")}-${o.padStart(2,"0")}`}renderNavigation({projects:t=null,handler:e=null}){this.dom.nav.innerHTML=`
